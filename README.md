...
To start the game, you would invite someone to your game. They have to accept the invitation in order to start playing. You would then list out the tasks you have. This doesn’t have to be by week, because some people may have fewer assignments per week, so they can just list the assignments they have till the foreseeable future and their due dates. Also, each task is weighted differently. If it's a simple assignment, it's not worth much compared to, like, a project, a long essay, a comprehensive assignment, or a lab report. 
